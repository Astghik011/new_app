    ...
    return (
        <main>
            {data.dessert.map((dessert, index)=>{ 
                return <div className={styles.productsMain}>
                <img className={styles.productsImg} 
                    src={require(`../images/dessert_images${dessert.url}`)} 
                    alt = {dessert.name} 
                    key = {index}
                />
                ...
                <span className={styles.productsMass}
                    key = {index}>
                    {dessert.weight}г
                </span>
